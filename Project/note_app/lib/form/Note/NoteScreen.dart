...
import 'package:note_app/db/NoteDatabase.dart';
...
class _NoteScreenState extends State<_NoteScreen> {
  ...
  Future<void> _refreshData() async {
    ...
    _categories = await CategorySQLHelper.getAllCategories(user.id!);
    _priorities = await PrioritySQLHelper.getAllPriorities(user.id!);
    _statuses = await StatusSQLHelper.getAllStatuses(user.id!);
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Container(
                                                ...
                                                child: Text("Category: ${_notes[index][Constant.KEY_NOTE_CATEGORY_NAME]}", style: textNormalStyle,),
                                              )
                                            ],
                                          ),
                                        ),
                                        Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Container(
                                                margin: const EdgeInsets.only(left: 5),
                                                child: Text("Priority:${_notes[index][Constant.KEY_NOTE_PRIORITY_NAME]}", style: textNormalStyle,),
                                              )
                                            ],
                                          ),
                                        ),
                                        Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Container(
                                                margin: const EdgeInsets.only(left: 5),
                                                child: Text("Status: ${_notes[index][Constant.KEY_NOTE_STATUS_NAME]}", style: textNormalStyle,),
                                              )
                                            ],
                                          ),
                                        ),
                                        Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Container(
                                                margin: const EdgeInsets.only(left: 5),
                                                child: Text("Plan Date: ${_notes[index][Constant.KEY_NOTE_PLAN_DATE]}", style: textNormalStyle,),
                                              )
                                            ],
                                          ),
                                        ),
                                        Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Container(
                                                margin: const EdgeInsets.only(left: 5),
                                                child: Text("Created at: ${_notes[index][Constant.KEY_NOTE_CREATED_DATE]}", style: textNormalStyle,),
                                              )
                                            ],
                                          ),
                                        ),
