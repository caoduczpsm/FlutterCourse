...
class _HomeScreenState extends State<_HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    for (var item in _countStatus) {
      dataMap[item[Constant.KEY_NOTE_STATUS_NAME]] = item[Constant.KEY_STATUS_COUNT].toDouble();
      randomColors.add(Color.fromARGB(Random().nextInt(256), Random().nextInt(256), Random().nextInt(256), Random().nextInt(256)));
    }
