...
class NoteSQLHelper {
  ...
  // static Future<List<Map<String, dynamic>>> getAllNotes(int userId) async {
  //   final db = await AppSQLHelper.db();
  //
  //   return db.query(Constant.KEY_TABLE_NOTE, orderBy: "id", where: '${Constant.KEY_NOTE_USER_ID} = ?', whereArgs: [userId]);
  // }
  ...
  static Future<List<Map<String, dynamic>>> getNoteDetailById(int id) async {
    ...
    final maps = await db.rawQuery('''
      ...
      LEFT JOIN ${Constant.KEY_TABLE_CATEGORY} ON ${Constant.KEY_TABLE_NOTE}.${Constant.KEY_NOTE_CATEGORY_ID} = ${Constant.KEY_TABLE_CATEGORY}.${Constant.KEY_CATEGORY_ID}
      ...
      LEFT JOIN ${Constant.KEY_TABLE_PRIORITY} ON ${Constant.KEY_TABLE_NOTE}.${Constant.KEY_NOTE_PRIORITY_ID} = ${Constant.KEY_TABLE_PRIORITY}.${Constant.KEY_PRIORITY_ID}
